         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="doctor_management.php" > Doctors </a>
                  </li>
				  <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               ...
               <div class="navbar-header" >
                  <a class="navbar-brand" href="index.php"><img src="css/logo.png" width="60" height="60">4pets</a>
                  <a class="navbar-brand hidden" href="index.php"><img src="css/logo.png" width="60" height="60"></a>
