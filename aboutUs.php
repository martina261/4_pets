            ...
            <div class="col-md-4">
                ...
                <div class="card cardView h-100" id="wellnesscheckups" >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text scroller">It’s important for your pet to see a vet at least once each year. We
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="surgery">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text scroller">As a full service veterinary clinic, we offer cutting-edge, affordable
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="lasertherapy" >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text scroller">Used to treat a variety of conditions, laser therapy is a non-invasive,
    ...
    <div class="paragraph">
        <h2>General Q&A</h2>
            ...
            <div class="card FAQcards">
                    ...
                    <button data-target="#answer1" class="btn dropdown-toggle "
                    data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer2" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer3" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
            <p id="answer3" class="collapse">While some plants can just give your dog diarrhea, there are others that
                ...
                If you think your dog has ingested a poisonous substance, <a href="ContactUs.html"
                    target="_blank">Contact Us</a> or hurry up to make one of our vets see your dog.</p>
        </div>

        <div class="card FAQcards">
            <h4>What foods are toxic for cats and dogs?</h4>
            <button data-target="#answer4" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer5" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer6" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer7" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer8" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer9" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer10" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
        ...
        <div class="card FAQcards">
            ...
            <button data-target="#answer11" class="btn dropdown-toggle"
                data-toggle="collapse">Answer</button>
