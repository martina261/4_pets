            ...
            <form onsubmit="validation()" action="signup_post.php" method="post" name="regForm">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phoneNumber" class="form-control" name="phone" pattern="01[0-2,5]{1}[0-9]{8}" required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gender" value="Male" id="femaleGender" checked />Male


                            <input class="form-check-input p-1" type="radio" name="gender" value="Female" id="maleGender " style="margin-left: 50px;" />Female
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="psw" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="psw2" name="confirmpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must
                    contain at least one number and one uppercase and lowercase letter, and at least 8 or more
                    characters" required>
                    </div>

                    <div class="btns text-center">
                        <button name="submit" type="submit" id="submit" onclick="matchPassword()" class="btn btn-outline-primary mr-3">Register</button>
