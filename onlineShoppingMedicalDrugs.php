...
<body>
    ...
    <h1 class="mainHeading">Medical Drugs</h1>


    
    <div id="slide" class="carousel slide container ">
        <h2 class="heading">Dogs' Medical Drugs</h2>
    ...
    <div id="slidee" class="carousel slide container ">
        <h2 class="heading">Cats' Medical Drugs</h2>
        <ol class="carousel-indicators">
    ...
    <div id="slideee" class="carousel slide container ">
        <h2 class="heading">Mice Medical Drugs</h2>
        <ol class="carousel-indicators">
