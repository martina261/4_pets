                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="x">
                            <form method="post" action="#">
                                <div class="text-primary" style="font-size:60px"
                                ...
                                <div id="textt" class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="textarea" class="form-control" id="Message" required
                                ...
                                <button type="submit" class="btn btn-outline-primary btn-group-lg btn-block">Send
                                    Message</button>
